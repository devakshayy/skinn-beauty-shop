...
const OrderEnquiryForm = () => {
  ...
  const EMAILJS_CONFIG = {
    publicKey: 's6hG-8f4lil5t_eXS',
    serviceId: 'service_6jkz5ss',
    templateId: 'template_xwz0brg',
  };
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600">
                Interested in our beauty products? Fill out the form below and
            ...
            <p className="text-xs text-gray-500 text-center mt-10">
              We typically respond within 24 hours. All enquiries are
              confidential.
            </p>
          </div>
        </div>
